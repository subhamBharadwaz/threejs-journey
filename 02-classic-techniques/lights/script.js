...
ambientLightControls.add(ambientLight, 'intensity').min(0).max(1).step(0.01);
...
const hemisphereLightControls = gui.addFolder('Hemisphere Light');
...
pointLightControls.add(pointLight, 'intensity').min(0).max(1).step(0.01);
...
const rectAreaLightControls = gui.addFolder('Rect Area Light');
